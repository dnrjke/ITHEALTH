...
const translations = {
    KR: {
        ...
        intro: {
            ...
            lead1: '<span class="keep-phrase">장시간 데스크워크로</span> <span class="break-after">몸에 무리가 가고 있지는 않나요?</span>',
            lead2: '자세가 무너지고 있지는 않나요?',
            purpose1: '<span class="keep-phrase">IT 작업은 현대인에게</span> <span class="break-after">피할 수 없는 일입니다.</span>',
            purpose2: '<span class="keep-phrase">그렇기에 몸을 지키는</span> <span class="break-after">지식이 필요합니다.</span>',
            purpose3: '<span class="keep-phrase">당신이 궁금해할 건강 정보를</span> <span class="break-after">여기 모았습니다.</span>',
            ...
            howtoItems: {
                quickBreak: {
                    title: '5분 휴식 가이드',
                    desc: '즉시 실천 가능한 5분 스트레칭으로 컨디션을 리셋하세요'
                },
                symptomGuides: {
                    title: '증상별 가이드',
                    desc: '내 상태에 맞는 건강 정보를 빠르게 찾아보세요'
                },
                routineRest: {
                    title: '휴식 루틴 만들기',
                    desc: '부위별 휴식 가이드를 조합해 나만의 루틴을 만들어보세요'
                },
                checklist: {
                    title: '건강 체크리스트',
                    desc: '지금 내 상태를 점검하고 맞춤 휴식 가이드를 추천받으세요'
                }
            },
        ...
        checklist: {
            ...
            questions: {
                ...
                overnight: '어젯밤 밤을 새웠나요?',
                overdrink: '최근 과음으로 컨디션이 떨어졌나요?',
                breakIrregular: '휴식 리듬이 깨져 피로가 누적된 느낌인가요?'
            },
            tips: {
            ...
            guideRecommend: {
                ...
                'rest-overnight': { desc: '밤샘 후 과각성을 낮추는 5분 리셋' },
                'rest-overdrink': { desc: '과음 다음 날 회복을 돕는 부드러운 루틴' },
                'rest-balanced': { desc: '리듬을 지키는 “짧고 자주” 회복 루틴' }
            }
        },
        // --- 휴식 가이드 ---
        restGuide: {
            ...
            special: {
                title: '✨ 특별 상황 휴식 가이드',
                desc1: '어떤 날은 “평소 루틴”만으로 회복이 잘 안 됩니다. 아래 가이드는 특정 상황에서 몸과 마음을 더 빠르게 안정시키기 위한, 짧고 현실적인 휴식 전략을 담았습니다.',
                cards: {
                    overnight: {
                        title: '밤샘 휴식 가이드',
                        desc: '잠을 대체할 수 있는 휴식은 없습니다. 다만 당장 버텨야 한다면, “과각성”을 낮추고 집중력을 유지하는 방향으로 몸을 리셋해보세요.',
                        mobileDesc: '과각성을 낮추고 집중력을 보호하는 5분 리셋'
                    },
                    overdrink: {
                        title: '과음 휴식 가이드',
                        desc: '과음 다음 날에는 무리한 운동보다, 수분/호흡/가벼운 움직임으로 컨디션을 “천천히” 끌어올리는 게 핵심입니다.',
                        mobileDesc: '수분·호흡·가벼운 움직임으로 회복 가속'
                    },
                    balanced: {
                        title: '적절한 휴식 가이드',
                        desc: '일할 때도, 쉴 때도 “짧고 자주”가 가장 효율적입니다. 지금 내 리듬을 망치지 않는 선에서 회복을 설계해보세요.',
                        mobileDesc: '리듬을 지키며 회복 효율을 올리는 루틴'
                    }
                }
            },
        ...
        restGuideData: {
            ...
            'rest-overnight': {
                label: '밤샘 휴식 가이드',
                steps: [
                    { title: '자세·눈 리셋', time: '1분', description: '어깨를 내리고 턱을 살짝 당겨, 화면을 보는 자세를 먼저 정리합니다.', tips: ['어깨를 한 번 크게 올렸다가 툭 떨어뜨리기', '턱을 살짝 당겨 목 뒤를 길게 만들기', '모니터에서 2m 이상 먼 곳 10초 보기'] },
                    { title: '호흡으로 과각성 낮추기', time: '2분', description: '짧은 호흡은 몸을 더 긴장시키기 쉽습니다. 내쉬는 시간을 길게 가져가며 리듬을 안정화합니다.', tips: ['코로 4초 들이마시고 6초 내쉬기 (6회)', '숨을 내쉴 때 어깨 힘을 함께 빼기', '손가락/발가락에 힘을 줬다 풀며 긴장 분리'] },
                    { title: '미세 휴식 계획 세우기', time: '2분', description: '지금 필요한 건 ‘완벽한 회복’이 아니라 ‘무너짐 방지’입니다. 다음 30~60분을 버틸 휴식 단위를 정합니다.', tips: ['물 한 모금 + 30초 창밖 보기', '25~30분 집중 후 2~3분 일어나 걷기', '카페인은 소량, 물과 함께'] }
                ]
            },
            'rest-overdrink': {
                label: '과음 휴식 가이드',
                steps: [
                    { title: '수분 리셋', time: '1분', description: '속이 불편하다면 천천히, 가능한 범위에서 수분을 보충합니다.', tips: ['물을 한 번에 많이 마시지 말고 조금씩', '가능하면 미지근한 물로 시작', '카페인은 당장은 줄이기'] },
                    { title: '편안한 호흡', time: '2분', description: '호흡을 정리하면 어지러움/불안감이 완화되는 경우가 있습니다. 무리 없이 천천히 진행하세요.', tips: ['4초 들이마시고 6초 내쉬기 (6회)', '복부가 부풀었다 들어가는 감각만 관찰', '어깨와 턱에 힘이 들어가면 바로 풀기'] },
                    { title: '가벼운 움직임', time: '2분', description: '격한 운동 대신, 몸을 깨우는 정도의 가벼운 움직임으로 순환을 돕습니다.', tips: ['자리에서 일어나 종아리 들었다 내리기 (10회)', '상체를 좌우로 천천히 비틀기 (각 5회)', '무리한 스트레칭/달리기는 피하기'] }
                ]
            },
            'rest-balanced': {
                label: '적절한 휴식 가이드',
                steps: [
                    { title: '휴식 목표 정하기', time: '1분', description: '지금 내 상태를 10초만 점검하고, “어떤 회복”이 필요한지 하나만 정합니다.', tips: ['눈 피로 / 어깨 긴장 / 머리 멍함 중 1개 선택', '선택한 부위에만 집중', '휴식은 짧아도 괜찮습니다'] },
                    { title: '짧고 자주: 리듬 만들기', time: '2분', description: '긴 휴식보다 “짧은 회복”을 자주 넣는 게 유지하기 쉽습니다. 당장 적용 가능한 루틴으로 연결합니다.', tips: ['25~50분 집중 + 2~10분 휴식', '휴식 때는 자리에서 일어나기', '휴식 중엔 화면을 멀리하기'] },
                    { title: '몸-호흡 동기화', time: '2분', description: '간단한 동작과 호흡을 맞추면 회복 체감이 빨라집니다. 천천히, 통증 없이 진행하세요.', tips: ['들이마실 때 팔을 올리고, 내쉴 때 내리기 (5회)', '목을 좌우로 기울이며 호흡 (각 3회)', '마지막 10초는 눈 감고 호흡만'] }
                ]
            }
        },
        // --- 질병 정보 ---
        ...
        healthTips: {
            ...
            overnight: { title: '밤샘 후 회복이 필요해요', tips: ['가능하면 10~20분 짧은 휴식(눈 감기)을 시도해보세요', '물을 조금씩 자주 마시고, 카페인은 소량만 유지하세요', '25~30분 집중 후 2~3분 걷는 리듬으로 버텨보세요'] },
            overdrink: { title: '과음 후 회복이 필요해요', tips: ['수분을 조금씩 보충하고, 속이 불편하면 무리하지 마세요', '무리한 운동은 피하고 가벼운 움직임으로 순환만 돕습니다', '짠 음식/카페인 과다 섭취는 피해주세요'] },
            'break-irregular': { title: '휴식 리듬을 다시 잡아봐요', tips: ['“짧고 자주” 휴식으로 리듬을 되돌려보세요', '휴식 시간엔 화면을 멀리하고, 가능하면 일어나세요', '오늘만큼은 무리한 목표보다 지속 가능한 페이스를 우선하세요'] }
        }
    },
    // ========== ENGLISH ==========
    EN: {
        common: { start: 'Start', next: 'Next Step', complete: 'Complete', close: 'Close', pause: 'Pause', resume: 'Resume', comingSoon: 'Coming soon' },
        ...
        intro: {
            ...
            lead1: '<span class="keep-phrase">Is your body strained</span> <span class="break-after">from long desk work?</span>',
            lead2: 'Is your posture collapsing?',
            purpose1: '<span class="keep-phrase">IT work is unavoidable</span> <span class="break-after">for modern people.</span>',
            purpose2: '<span class="keep-phrase">Therefore, knowledge to protect your body</span> <span class="break-after">is needed.</span>',
            purpose3: '<span class="keep-phrase">We gathered health information</span> <span class="break-after">you might wonder about.</span>',
            ...
            howtoItems: {
                quickBreak: {
                    title: '5-min Break Guide',
                    desc: 'Reset your condition with a practical 5-minute stretch you can do now'
                },
                symptomGuides: {
                    title: 'Symptom Guides',
                    desc: 'Quickly find health information that fits your current condition'
                },
                routineRest: {
                    title: 'Build a Rest Routine',
                    desc: 'Combine body-part rest guides to create your own routine'
                },
                checklist: {
                    title: 'Health Checklist',
                    desc: 'Check your condition and get recommended rest guides'
                }
            },
        ...
        checklist: {
            ...
            guideRecommend: {
                ...
                'rest-overnight': { desc: 'A 5-minute reset to reduce over-arousal after an all-nighter' },
                'rest-overdrink': { desc: 'A gentle routine to recover the day after drinking' },
                'rest-balanced': { desc: 'Short-and-frequent recovery rhythm that protects your pace' }
            }
        },
        restGuide: {
            ...
            special: {
                title: '✨ Special Situation Rest Guides',
                desc1: 'Some days, your usual routine isn’t enough. These guides offer short, realistic strategies to stabilize your body and mind faster in specific situations.',
                cards: {
                    overnight: {
                        title: 'Overnight Work Rest Guide',
                        desc: 'Nothing truly replaces sleep. But if you must push through, reset your body by lowering over-arousal and protecting your focus.',
                        mobileDesc: 'A 5-minute reset to reduce over-arousal and protect focus'
                    },
                    overdrink: {
                        title: 'After-Drinking Rest Guide',
                        desc: 'The day after drinking, skip intense workouts. Focus on hydration, breathing, and light movement to recover steadily.',
                        mobileDesc: 'Hydration, breathing, and light movement for steady recovery'
                    },
                    balanced: {
                        title: 'Balanced Rest Guide',
                        desc: 'The most efficient rest is short and frequent. Design recovery that helps you bounce back without breaking your rhythm.',
                        mobileDesc: 'A routine that boosts recovery without breaking your rhythm'
                    }
                }
            },
        ...
        restGuideData: {
            ...
            'rest-overnight': {
                label: 'Overnight Work Rest Guide',
                steps: [
                    { title: 'Posture & Eye Reset', time: '1 min', description: 'Drop your shoulders and gently tuck your chin to reset screen posture.', tips: ['Raise shoulders once, then release', 'Slightly tuck chin to lengthen the back of your neck', 'Look at a point 2m+ away for 10 seconds'] },
                    { title: 'Lower Over-arousal with Breathing', time: '2 min', description: 'Short breathing can increase tension. Extend the exhale to stabilize your rhythm.', tips: ['Inhale 4s, exhale 6s (6 rounds)', 'Release shoulder tension as you exhale', 'Tense and release fingers/toes to separate tension'] },
                    { title: 'Plan Micro-breaks', time: '2 min', description: 'You don’t need perfect recovery right now—you need to prevent a crash. Set a micro-break rhythm for the next 30–60 minutes.', tips: ['Sip water + look away for 30 seconds', 'Focus 25–30 min, then walk 2–3 min', 'Keep caffeine small and pair with water'] }
                ]
            },
            'rest-overdrink': {
                label: 'After-Drinking Rest Guide',
                steps: [
                    { title: 'Hydration Reset', time: '1 min', description: 'If your stomach feels off, hydrate slowly within your comfort range.', tips: ['Sip—don’t chug', 'Start with lukewarm water if possible', 'Reduce caffeine for now'] },
                    { title: 'Gentle Breathing', time: '2 min', description: 'Calmer breathing can ease dizziness or anxiety for some people. Keep it slow and comfortable.', tips: ['Inhale 4s, exhale 6s (6 rounds)', 'Notice the belly rising and falling', 'Release tension in shoulders and jaw'] },
                    { title: 'Light Movement', time: '2 min', description: 'Skip intense workouts. Use light movement to support circulation and wake the body up.', tips: ['Stand and do calf raises (10 reps)', 'Slowly twist upper body left/right (5 each)', 'Avoid hard stretches or running'] }
                ]
            },
            'rest-balanced': {
                label: 'Balanced Rest Guide',
                steps: [
                    { title: 'Pick One Recovery Goal', time: '1 min', description: 'Check in for 10 seconds and choose just one: eye fatigue, shoulder tension, or mental fog.', tips: ['Pick one and focus only on it', 'Small breaks still count', 'Stop if there is pain'] },
                    { title: 'Short & Frequent Rhythm', time: '2 min', description: 'Short recovery breaks are easier to sustain than long ones. Connect this to a realistic work rhythm.', tips: ['Focus 25–50 min + rest 2–10 min', 'Stand up during rest', 'Look away from screens during rest'] },
                    { title: 'Sync Body with Breath', time: '2 min', description: 'Simple movement plus breathing can speed up the recovery feeling. Move slowly and comfortably.', tips: ['Inhale: raise arms / exhale: lower (5 rounds)', 'Tilt neck side to side with breathing (3 each)', 'Finish with 10 seconds eyes closed, breathing only'] }
                ]
            }
        },
        diseases: {
        ...
        healthTips: {
            ...
            overnight: { title: 'You need recovery after an all-nighter', tips: ['If possible, try a short 10–20 min eyes-closed rest', 'Sip water frequently and keep caffeine small', 'Use a 25–30 min focus + 2–3 min walk rhythm'] },
            overdrink: { title: 'You need recovery after drinking', tips: ['Hydrate slowly—don’t force it if your stomach feels off', 'Avoid intense workouts; use light movement for circulation', 'Avoid excessive salty foods and too much caffeine'] },
            'break-irregular': { title: 'Let’s rebuild your break rhythm', tips: ['Bring back a “short and frequent” recovery rhythm', 'During breaks, look away from screens and stand up if possible', 'Prioritize sustainable pace over aggressive goals today'] }
        }
    },
    // ========== JAPANESE ==========
    JP: {
        common: { start: '始める', next: '次へ', complete: '完了', close: '閉じる', pause: '一時停止', resume: '再開', comingSoon: '準備中' },
        ...
        intro: {
            mainTitle: '<span class="keep-phrase">IT&HEALTHガイドへ</span><span class="break-after">ようこそ</span>',
            lead1: '<span class="keep-phrase">長時間のデスクワークで</span> <span class="break-after">体に無理をしていませんか？</span>',
            lead2: '姿勢が崩れていませんか？',
            purpose1: '<span class="keep-phrase">IT作業は現代人にとって</span> <span class="break-after">避けられないことです。</span>',
            purpose2: '<span class="keep-phrase">だからこそ体を守る</span> <span class="break-after">知識が必要です。</span>',
            purpose3: '<span class="keep-phrase">あなたが気になる健康情報を</span> <span class="break-after">ここに集めました。</span>',
            contentTitle: '主な健康情報',
            cardCta: '詳しく見る',
            card1Title: '頭痛と無気力',
            ...
            howtoItems: {
                quickBreak: {
                    title: '5分休憩ガイド',
                    desc: '今すぐできる5分ストレッチでコンディションをリセット'
                },
                symptomGuides: {
                    title: '症状別ガイド',
                    desc: '今の状態に合った健康情報を素早く探しましょう'
                },
                routineRest: {
                    title: '休憩ルーティン作り',
                    desc: '部位別の休憩ガイドを組み合わせて自分のルーティンに'
                },
                checklist: {
                    title: '健康チェックリスト',
                    desc: '今の状態をチェックして休憩ガイドのおすすめを受け取りましょう'
                }
            },
        ...
        checklist: {
            ...
            questions: { water: '過去1時間以内に水を飲みましたか？', meal: '今日食事を抜いていませんか？', neckForward: '首が前に出ていますか？', shoulder: '肩に緊張やこりがありますか？', backCurved: '背中が丸まっていますか？', sitting: '1時間以上同じ姿勢で座っていましたか？', handPain: '手首や指に痛みがありますか？', wristAngle: '手首を曲げた状態でタイピングしていますか？', eyes: '目が疲れたり乾燥していますか？', headache: '頭が重かったり頭痛がありますか？', overnight: '昨夜は徹夜しましたか？', overdrink: '最近飲みすぎで調子が落ちていますか？', breakIrregular: '休憩リズムが崩れて疲れが溜まっている感じがしますか？' },
            tips: {
            ...
            guideRecommend: {
                ...
                'rest-overnight': { desc: '徹夜後の過覚醒を下げる5分リセット' },
                'rest-overdrink': { desc: '飲みすぎ翌日の回復を支える優しいルーティン' },
                'rest-balanced': { desc: 'ペースを守る「短く、こまめに」回復リズム' }
            }
        },
        restGuide: {
            ...
            special: {
                title: '✨ 特別な状況の休憩ガイド',
                desc1: 'いつものルーティンだけでは回復しにくい日もあります。下のガイドは、特定の状況で心身をより早く落ち着かせるための、短く現実的な休憩戦略をまとめました。',
                cards: {
                    overnight: {
                        title: '徹夜の休憩ガイド',
                        desc: '睡眠の代わりになる休憩はありません。それでも乗り切る必要があるなら、「過覚醒」を下げ、集中力を守る方向で体をリセットしましょう。',
                        mobileDesc: '過覚醒を下げ、集中力を守る5分リセット'
                    },
                    overdrink: {
                        title: '飲みすぎ後の休憩ガイド',
                        desc: '飲みすぎの翌日は無理な運動よりも、水分・呼吸・軽い動きでコンディションを“ゆっくり”戻すのがポイントです。',
                        mobileDesc: '水分・呼吸・軽い動きで回復をサポート'
                    },
                    balanced: {
                        title: '適切な休憩ガイド',
                        desc: '仕事でも休憩でも「短く、こまめに」が最も効率的です。今のリズムを崩さない範囲で回復を設計してみましょう。',
                        mobileDesc: 'リズムを崩さず回復効率を上げるルーティン'
                    }
                }
            },
        ...
        restGuideData: {
            ...
            'rest-overnight': {
                label: '徹夜の休憩ガイド',
                steps: [
                    { title: '姿勢・目のリセット', time: '1分', description: '肩を下げ、顎を軽く引いて画面姿勢を整えます。', tips: ['肩を一度大きく上げてから落とす', '顎を軽く引いて首の後ろを長くする', '2m以上先を10秒見る'] },
                    { title: '呼吸で過覚醒を下げる', time: '2分', description: '浅い呼吸は緊張を強めがちです。吐く時間を長くしてリズムを安定させます。', tips: ['4秒吸って6秒吐く(6回)', '吐くときに肩の力も抜く', '指先/つま先に力を入れて抜く'] },
                    { title: 'ミニ休憩を設計', time: '2分', description: '今必要なのは完璧な回復ではなく、崩れを防ぐこと。次の30〜60分のリズムを決めます。', tips: ['水を一口+30秒目線を外す', '25〜30分集中→2〜3分歩く', 'カフェインは少量、水と一緒に'] }
                ]
            },
            'rest-overdrink': {
                label: '飲みすぎ後の休憩ガイド',
                steps: [
                    { title: '水分リセット', time: '1分', description: '胃がつらい場合は無理せず、少しずつ水分を補給します。', tips: ['一気飲みせず少しずつ', '可能ならぬるめの水から', '今はカフェインを控える'] },
                    { title: '楽な呼吸', time: '2分', description: '呼吸が整うと、めまい/不安が和らぐことがあります。ゆっくり進めましょう。', tips: ['4秒吸って6秒吐く(6回)', 'お腹の上下だけ観察', '肩と顎の力を抜く'] },
                    { title: '軽い動き', time: '2分', description: '激しい運動は避け、軽い動きで循環をサポートします。', tips: ['その場でかかと上げ下げ(10回)', '上体を左右にゆっくりひねる(各5回)', '強いストレッチやランは避ける'] }
                ]
            },
            'rest-balanced': {
                label: '適切な休憩ガイド',
                steps: [
                    { title: '休憩の目的を1つ', time: '1分', description: '10秒だけ状態を確認し、目・肩・頭のうち1つだけ選びます。', tips: ['1つに絞って集中', '短い休憩でもOK', '痛みがあれば中止'] },
                    { title: '短くこまめに', time: '2分', description: '長い休憩より短い回復をこまめに。現実的なリズムに落とし込みます。', tips: ['25〜50分集中+2〜10分休憩', '休憩中は立つ', '休憩中は画面から離れる'] },
                    { title: '動き×呼吸', time: '2分', description: '簡単な動作と呼吸を合わせると回復の体感が早まります。ゆっくり行いましょう。', tips: ['吸う:腕を上げる/吐く:下げる(5回)', '首を左右に傾けて呼吸(各3回)', '最後10秒は目を閉じて呼吸だけ'] }
                ]
            }
        },
        diseases: {
        ...
        healthTips: {
            ...
            overnight: { title: '徹夜後の回復が必要です', tips: ['可能なら10〜20分だけ目を閉じて休みましょう', '水分をこまめに取り、カフェインは少量に', '25〜30分集中→2〜3分歩くリズムを試しましょう'] },
            overdrink: { title: '飲みすぎ後の回復が必要です', tips: ['水分は少しずつ補給し、無理はしない', '激しい運動は避け、軽い動きで循環をサポート', '塩分の摂りすぎやカフェイン過多は避けましょう'] },
            'break-irregular': { title: '休憩リズムを整えましょう', tips: ['「短く、こまめに」でリズムを戻します', '休憩中は画面から離れ、可能なら立ち上がる', '今日は無理な目標より持続できるペースを優先'] }
        }
    }
};
